...
export const SEO: Record<Locale, LocaleSEO> = {
  en: {
    ...
    home: {
      title: 'Erdos Cashmere — Ordos Cashmere Factory, Yarn & Knitwear Wholesale | DONGXIAO®',
      description: 'Erdos cashmere from our Ordos, Inner Mongolia factory. 23+ years direct-from-mill pricing on yarn, scarves, sweaters, hats, accessories. MOQ 50–100 pcs. Request written quote.',
      keywords: ['erdos cashmere', 'erdos clothing', 'erdos cashmere factory', 'erdos cashmere supplier',
        'cashmere manufacturer', 'B2B cashmere supplier', 'Ordos cashmere factory wholesale',
        'Inner Mongolia cashmere manufacturer', 'erdos cashmere direct from mill',
        'Ordos cashmere catalogue', 'Ordos cashmere scarves', 'wholesale cashmere yarn',
        'cashmere OEM', 'luxury knitwear manufacturer', 'Europe cashmere supplier',
        'USA cashmere wholesale', 'erdos cashmere manufacturer', 'erdos clothing website',
        'erdos cashmere clothing', 'ordos cashmere clothing'],
    },
    rawMaterial: {
    ...
    yarnFabric: {
      ...
      keywords: ['erdos cashmere yarn', 'erdos cashmere factory yarn', 'cashmere yarn wholesale',
        ...
        'cashmere yarn 26/2', 'cashmere yarn 36/2', 'cashmere yarn 48/2',
        'worsted cashmere yarn', 'woolen cashmere yarn', '100% cashmere yarn',
        'cashmere silk blend yarn', 'cashmere wool blend yarn', 'cashmere linen blend yarn',
        'YARK cotton cashmere yarn', 'Ordos cashmere yarn manufacturer',
        'cashmere coating fabric', 'woven cashmere fabric', 'cashmere jacquard fabric',
        'lightweight cashmere fabric', 'cashmere silk blend fabric',
        ...getSeoKeywords('en', 'pricing'),
      ],
    },
    garmentOem: {
      title: 'Erdos Clothing Wholesale — Ordos Cashmere Garment OEM/ODM | DONGXIAO®',
      description: 'Erdos clothing wholesale from our Ordos, Inner Mongolia factory. Custom cashmere sweaters, scarves, hats, accessories. Private-label OEM/ODM, MOQ 50 pcs, sample 7–10 days, written quotation.',
      keywords: ['erdos clothing', 'erdos clothing wholesale', 'erdos cashmere garment',
        'erdos cashmere sweater', 'cashmere sweater OEM', 'cashmere garment manufacturer',
        'private label cashmere', 'custom cashmere knitwear', 'cashmere coat manufacturer',
        'custom cashmere sweater wholesale', 'cashmere scarf shawl factory',
        'private label cashmere knitwear', 'cashmere hat glove wholesale',
        'luxury cashmere blanket supplier', 'private label cashmere sweater factory Ordos China',
        'small MOQ cashmere coat manufacturer', 'wholesale cashmere shawl with custom logo',
    ...
    ordosOrigin: {
      title: 'Erdos Cashmere Factory — Ordos Inner Mongolia Origin & Heritage | DONGXIAO®',
      description: "Erdos cashmere factory located in Ordos, Inner Mongolia. Discover the world's premium cashmere origin: Albus goat breeding, climate, traceability, and full-chain production from our facility.",
      keywords: ['erdos cashmere factory', 'erdos cashmere', 'Ordos cashmere factory',
        'Inner Mongolia cashmere factory', 'cashmere factory direct from mill',
        'Ordos cashmere origin', 'Inner Mongolia cashmere', 'Albus goat', 'cashmere terroir',
        'sustainable cashmere', 'Ordos & Mongolian cashmere supplier',
        '100% Ordos cashmere', 'pure Mongolian raw cashmere',
        'Inner Mongolia Ordos cashmere factory', 'mixed Ordos Mongolian cashmere yarn',
  ...
  cn: {
    ...
    home: {
      ...
      keywords: ['羊绒B2B采购', '羊绒产品资料', '羊绒原料', '羊绒纱线', '羊绒面料', '羊绒针织成衣', '羊绒产品规格', '羊绒OEM项目沟通'],
    },
    rawMaterial: {
