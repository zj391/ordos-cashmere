...
export const TAG_PAGES: Record<string, TagSeoEntry> = {
  ...
  'cashmere-sweaters-for-women': {
    ...
    keywords: ['cashmere sweaters for women', 'women cashmere cardigan', 'cashmere pullover women', 'cashmere womens knitwear', 'womens cashmere sweater wholesale', 'cashmere cardigan wholesale', 'cashmere sweater manufacturer', 'luxury cashmere sweater', 'luxury cashmere cardigan', 'cashmere duster', 'long cashmere cardigan', 'cashmere duster coat'],
    categoryId: 'sweaters',
    matchField: 'all',
  ...
  'cashmere-scarves-for-women': {
    ...
    keywords: ['cashmere scarves for women', 'women cashmere scarf', 'cashmere scarf women', 'womens cashmere scarf', 'cashmere hijab scarf', 'luxury cashmere scarf', 'printed cashmere scarf', 'cashmere scarf manufacturer'],
    categoryId: 'scarves',
    matchField: 'all',
    matchKeywords: ['ladies', 'women'],
  },
  ...
  'cashmere-mens-knitwear': {
    ...
    keywords: ['cashmere mens sweater', 'cashmere mens cardigan', 'cashmere pullover men', 'cashmere knitwear men', 'mens cashmere wholesale', 'cashmere mens sweater manufacturer', 'cashmere polo men', 'mens cashmere polo', 'cashmere polo sweater men', 'men cashmere polo sweater'],
    categoryId: 'sweaters',
    matchField: 'all',
