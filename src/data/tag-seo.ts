...
export const TAG_PAGES: Record<string, TagSeoEntry> = {
  ...
  'cashmere-hoodies': {
    title: 'Cashmere Hoodie Wholesale | Knit Hooded Sweater Manufacturer | DONGXIAO®',
    description: 'Wholesale cashmere hoodies and hooded sweaters: jacquard cable-knit, button-front, drawcord hood. 14–15.5µm Mongolian cashmere, 7–12gg. MOQ 100, sample 10–14 days.',
    h1: 'Cashmere Hoodies Wholesale',
    intro: 'Browse cashmere hoodies from our Ordos facility: jacquard cable-knit, button-front, kangaroo pocket. Each is knit from 14–15.5µm Mongolian cashmere on 7–12 gauge machines.',
    keywords: ['cashmere hoodie', 'cashmere hoodies wholesale', 'cashmere hoodie manufacturer', 'knit cashmere hoodie', 'cashmere hooded sweater', 'cable knit cashmere hoodie'],
    categoryId: 'sweaters',
    matchField: 'all',
    matchKeywords: ['hoodie', 'hooded'],
  },
  'cashmere-kids-cardigans': {
    title: 'Kids Cashmere Cardigan Wholesale | Children\'s Knit Cardigan | DONGXIAO®',
    description: 'Wholesale kids cashmere cardigans: 3-ply thick space-dye knit, V-neck and crew-neck. 14–15.5µm Mongolian cashmere. MOQ 100.',
    h1: 'Kids Cashmere Cardigans Wholesale',
    intro: 'Browse kids cashmere cardigans from our Ordos facility: 3-ply thick space-dye knit for cold weather.',
    keywords: ['kids cashmere cardigan', 'children cashmere cardigan', 'kids cashmere sweater', 'baby cashmere cardigan'],
    categoryId: 'sweaters',
    matchField: 'all',
    matchKeywords: ['kids', 'children', 'child'],
  },
  'cashmere-coats': {
    title: 'Cashmere Wool Coat Wholesale | Double-Face Wool Overcoat | DONGXIAO®',
    description: 'Wholesale cashmere wool coats and double-face wool overcoats: button-front closure, notch collar. 14–15.5µm Mongolian cashmere + wool blend. MOQ 100.',
    h1: 'Cashmere Wool Coats Wholesale',
    intro: 'Browse cashmere wool coats from our Ordos facility: notch-collar button-front overcoats, cashmere-wool blend construction.',
    keywords: ['cashmere coat', 'cashmere wool coat', 'double face wool coat', 'cashmere overcoat wholesale'],
    categoryId: 'sweaters',
    matchField: 'all',
    matchKeywords: ['coat', 'overcoat'],
  },
  'cashmere-mock-neck': {
    title: 'Cashmere Mock Neck Sweater Wholesale | Half Turtleneck Pullover | DONGXIAO®',
    description: 'Wholesale cashmere mock neck sweaters and half-turtleneck pullovers. 14–15.5µm Mongolian cashmere, 12gg fine gauge. MOQ 100.',
    h1: 'Cashmere Mock Neck Sweaters Wholesale',
    intro: 'Browse cashmere mock neck sweaters from our Ordos facility: half-turtleneck pullovers, mock neck knitwear.',
    keywords: ['cashmere mock neck', 'mock neck cashmere sweater', 'half turtleneck cashmere', 'cashmere mock neck pullover', 'mock neck sweater wholesale'],
    categoryId: 'sweaters',
    matchField: 'all',
    matchKeywords: ['mock neck', 'mock', 'funnel'],
  },
};
...
export const TAG_PAGE_LOCALIZE: Record<string, Record<Locale, { title: string; description: string; h1: string; intro: string; keywords: string[] }>> = {
  ...
  'cashmere-hoodies': {
    en: { title: 'Cashmere Hoodie Wholesale | Knit Hooded Sweater Manufacturer | DONGXIAO®', description: 'Wholesale cashmere hoodies and hooded sweaters: jacquard cable-knit, button-front, drawcord hood. 14–15.5µm Mongolian cashmere, 7–12gg. MOQ 100.', h1: 'Cashmere Hoodies Wholesale', intro: 'Browse cashmere hoodies from our Ordos facility.', keywords: ['cashmere hoodie', 'cashmere hoodies wholesale', 'cable knit cashmere hoodie'] },
    cn: { title: '羊绒连帽衫批发 | 针织帽衫 | 东霄 DONGXIAO®', description: '羊绒连帽衫、针织帽衫批发：提花麻花、系扣、抽绳帽。14–15.5µm 蒙古羊绒。MOQ 100。', h1: '羊绒连帽衫批发', intro: '浏览鄂尔多斯工厂精选羊绒连帽衫。', keywords: ['羊绒连帽衫', '羊绒帽衫', '羊绒连帽衫批发'] },
    de: { title: 'Kaschmir-Hoodies Großhandel | DONGXIAO®', description: 'Großhandel Kaschmir-Hoodies und Kapuzenpullover.', h1: 'Kaschmir-Hoodies Großhandel', intro: 'Ausgewählte Kaschmir-Hoodies aus unserer Ordos-Fabrik.', keywords: ['Kaschmir Hoodie', 'Kaschmir Kapuzenpullover'] },
    fr: { title: 'Hoodies en Cachemire en Gros | DONGXIAO®', description: 'Hoodies et pulls à capuche en cachemire en gros.', h1: 'Hoodies en Cachemire', intro: 'Sélection de hoodies en cachemire de notre usine d\'Ordos.', keywords: ['hoodie cachemire', 'pull capuche cachemire'] },
    ja: { title: 'カシミア パーカー 卸売り | DONGXIAO®', description: 'カシミアパーカー、ニットフーディ卸売り。', h1: 'カシミアパーカー卸売り', intro: 'オルドス工場のカシミアパーカー。', keywords: ['カシミア パーカー', 'カシミア フーディ'] },
    kr: { title: '캐시미어 후디 도매 | DONGXIAO®', description: '캐시미어 후디, 니트 후드 스웨터 도매.', h1: '캐시미어 후디 도매', intro: '오르도스 공장의 캐시미어 후디.', keywords: ['캐시미어 후디', '캐시미어 후드'] },
  },
  'cashmere-kids-cardigans': {
    en: { title: 'Kids Cashmere Cardigan Wholesale | Children\'s Knit Cardigan | DONGXIAO®', description: 'Wholesale kids cashmere cardigans: 3-ply thick space-dye knit, V-neck and crew-neck. 14–15.5µm Mongolian cashmere. MOQ 100.', h1: 'Kids Cashmere Cardigans Wholesale', intro: 'Browse kids cashmere cardigans from our Ordos facility.', keywords: ['kids cashmere cardigan', 'children cashmere cardigan', 'kids cashmere sweater'] },
    cn: { title: '儿童羊绒开衫批发 | 童款针织衫 | 东霄 DONGXIAO®', description: '儿童羊绒开衫、童款针织衫批发：3 股加厚花纱、V 领、圆领。14–15.5µm 蒙古羊绒。MOQ 100。', h1: '儿童羊绒开衫批发', intro: '浏览鄂尔多斯工厂精选儿童羊绒开衫。', keywords: ['儿童羊绒开衫', '童款羊绒', '儿童羊绒衫'] },
    de: { title: 'Kaschmir-Kinderstrickjacken Großhandel | DONGXIAO®', description: 'Großhandel Kaschmir-Kinderstrickjacken und Kindermode.', h1: 'Kaschmir-Kinderstrickjacken', intro: 'Ausgewählte Kaschmir-Kinderstrickjacken aus unserer Ordos-Fabrik.', keywords: ['Kaschmir Kinderstrickjacke', 'Kaschmir Kindermode'] },
    fr: { title: 'Cardigans Enfant en Cachemire en Gros | DONGXIAO®', description: 'Cardigans enfant en cachemire en gros, tricot épais.', h1: 'Cardigans Enfant Cachemire', intro: 'Sélection de cardigans enfant en cachemire.', keywords: ['cardigan enfant cachemire', 'cachemire enfant'] },
    ja: { title: '子供カシミアカーディガン 卸売り | DONGXIAO®', description: '子供カシミアカーディガン、ベビーニット卸売り。', h1: '子供カシミアカーディガン卸売り', intro: 'オルドス工場の子供カシミアカーディガン。', keywords: ['子供 カシミア', 'ベビーカシミア'] },
    kr: { title: '어린이 캐시미어 가디건 도매 | DONGXIAO®', description: '어린이 캐시미어 가디건, 아기 니트 도매.', h1: '어린이 캐시미어 가디건', intro: '오르도스 공장의 어린이 캐시미어 가디건.', keywords: ['어린이 캐시미어', '아기 캐시미어'] },
  },
  'cashmere-coats': {
    en: { title: 'Cashmere Wool Coat Wholesale | Double-Face Wool Overcoat | DONGXIAO®', description: 'Wholesale cashmere wool coats and double-face wool overcoats: button-front closure, notch collar. 14–15.5µm Mongolian cashmere + wool blend. MOQ 100.', h1: 'Cashmere Wool Coats Wholesale', intro: 'Browse cashmere wool coats from our Ordos facility.', keywords: ['cashmere coat', 'cashmere wool coat', 'double face wool coat', 'cashmere overcoat wholesale'] },
    cn: { title: '羊绒羊毛大衣批发 | 双面呢大衣 | 东霄 DONGXIAO®', description: '羊绒羊毛大衣、双面呢大衣批发：纽扣门襟、戗驳领。14–15.5µm 蒙古羊绒 + 羊毛混纺。MOQ 100。', h1: '羊绒羊毛大衣批发', intro: '浏览鄂尔多斯工厂精选羊绒羊毛大衣、双面呢大衣。', keywords: ['羊绒大衣', '双面呢大衣', '羊绒羊毛大衣', '羊绒大衣批发'] },
    de: { title: 'Kaschmir-Wollmäntel Großhandel | DONGXIAO®', description: 'Großhandel Kaschmir-Wollmäntel und Doppelgewebe-Mäntel.', h1: 'Kaschmir-Wollmäntel', intro: 'Ausgewählte Kaschmir-Wollmäntel aus unserer Ordos-Fabrik.', keywords: ['Kaschmir Mantel', 'Kaschmir Wollmantel', 'Doppelgewebe Mantel'] },
    fr: { title: 'Manteaux Cachemire Laine en Gros | DONGXIAO®', description: 'Manteaux cachemire et laine en gros, double face.', h1: 'Manteaux Cachemire Laine', intro: 'Sélection de manteaux en cachemire et laine.', keywords: ['manteau cachemire', 'manteau laine cachemire', 'double face'] },
    ja: { title: 'カシミア ウール コート 卸売り | DONGXIAO®', description: 'カシミア・ウールコート、ダブルフェイス コート卸売り。', h1: 'カシミア コート卸売り', intro: 'オルドス工場のカシミア・ウールコート。', keywords: ['カシミア コート', 'カシミア ウール コート'] },
    kr: { title: '캐시미어 울 코트 도매 | DONGXIAO®', description: '캐시미어 울 코트, 더블페이스 코트 도매.', h1: '캐시미어 울 코트 도매', intro: '오르도스 공장의 캐시미어 울 코트.', keywords: ['캐시미어 코트', '캐시미어 울 코트'] },
  },
  'cashmere-mock-neck': {
    en: { title: 'Cashmere Mock Neck Sweater Wholesale | Half Turtleneck Pullover | DONGXIAO®', description: 'Wholesale cashmere mock neck sweaters and half-turtleneck pullovers. 14–15.5µm Mongolian cashmere, 12gg fine gauge. MOQ 100.', h1: 'Cashmere Mock Neck Sweaters Wholesale', intro: 'Browse cashmere mock neck sweaters from our Ordos facility.', keywords: ['cashmere mock neck', 'mock neck cashmere sweater', 'half turtleneck cashmere'] },
    cn: { title: '羊绒半高领套头衫批发 | 东霄 DONGXIAO®', description: '羊绒半高领套头衫批发：套头衫、高领针织衫。14–15.5µm 蒙古羊绒，12 针细针。MOQ 100 件。', h1: '羊绒半高领套头衫批发', intro: '浏览鄂尔多斯工厂精选羊绒半高领套头衫。', keywords: ['羊绒半高领', '羊绒高领', '羊绒套头衫'] },
    de: { title: 'Kaschmir-Rollkragenpullover Großhandel | DONGXIAO®', description: 'Großhandel Kaschmir-Rollkragenpullover und Mock-Neck-Pullover.', h1: 'Kaschmir-Rollkragenpullover', intro: 'Ausgewählte Kaschmir-Rollkragenpullover aus unserer Ordos-Fabrik.', keywords: ['Kaschmir Rollkragen', 'Kaschmir Mock Neck'] },
    fr: { title: 'Pulls Col Roulé Cachemire en Gros | DONGXIAO®', description: 'Pulls col roulé et mock neck en cachemire en gros.', h1: 'Pulls Col Roulé Cachemire', intro: 'Sélection de pulls col roulé en cachemire.', keywords: ['pull col roulé cachemire', 'mock neck cachemire'] },
    ja: { title: 'カシミア モックネック 卸売り | DONGXIAO®', description: 'カシミア モックネック、ハーフタートルネックの卸売り。', h1: 'カシミア モックネック卸売り', intro: 'オルドス工場のカシミア モックネック セーター。', keywords: ['カシミア モックネック', 'ハーフタートル カシミア'] },
    kr: { title: '캐시미어 목폴라 도매 | DONGXIAO®', description: '캐시미어 목폴라, 하프 터틀넥 도매.', h1: '캐시미어 목폴라 도매', intro: '오르도스 공장의 캐시미어 목폴라 스웨터.', keywords: ['캐시미어 목폴라', '캐시미어 하프 터틀넥'] },
  },
};