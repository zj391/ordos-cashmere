...
const labels: Record<string, Record<string, string>> = {
  en: { name: 'Name *', email: 'Email *', company: 'Company *', country: 'Country *', download: 'Request Documents', cancel: 'Close', submitting: 'Sending...', done: 'Request received', desc: 'For B2B sourcing review. The relevant document scope is confirmed in written correspondence for the project.', error: 'We could not record this request. Please try again or contact our sales team directly.' },
  cn: { name: '姓名 *', email: '邮箱 *', company: '公司 *', country: '国家 *', download: '申请资料', cancel: '关闭', submitting: '发送中...', done: '申请已收到', desc: '用于 B2B 采购核验。可提供资料的范围将结合项目需求以书面方式确认。', error: '资料申请未能提交，请重试或直接联系销售团队。' },
  de: { name: 'Name *', email: 'E-Mail *', company: 'Firma *', country: 'Land *', download: 'Unterlagen anfordern', cancel: 'Schließen', submitting: 'Wird gesendet...', done: 'Anfrage erhalten', desc: 'Für die B2B-Beschaffungsprüfung. Der relevante Unterlagenumfang wird schriftlich für das Projekt bestätigt.', error: 'Die Anfrage konnte nicht erfasst werden. Bitte erneut versuchen oder den Vertrieb direkt kontaktieren.' },
  fr: { name: 'Nom *', email: 'Email *', company: 'Société *', country: 'Pays *', download: 'Demander les documents', cancel: 'Fermer', submitting: 'Envoi...', done: 'Demande reçue', desc: 'Pour la validation B2B. Le périmètre de documents est confirmé par écrit selon le projet.', error: 'La demande n’a pas pu être enregistrée. Veuillez réessayer ou contacter directement notre équipe.' },
  ja: { name: 'お名前 *', email: 'メール *', company: '会社 *', country: '国 *', download: '資料を請求', cancel: '閉じる', submitting: '送信中...', done: '資料請求を受け付けました', desc: 'B2B 調達審査用です。資料範囲は案件ごとに書面で確認します。', error: '資料請求を記録できませんでした。もう一度お試しいただくか、営業担当へ直接ご連絡ください。' },
  kr: { name: '이름 *', email: '이메일 *', company: '회사 *', country: '국가 *', download: '자료 요청', cancel: '닫기', submitting: '보내는 중...', done: '자료 요청이 접수되었습니다', desc: 'B2B 소싱 검토용입니다. 자료 범위는 프로젝트별로 서면 확인합니다.', error: '요청을 기록하지 못했습니다. 다시 시도하거나 영업팀에 직접 문의해 주세요.' },
};
