...
app.get("/privacy-policy", (req, res) => {
  ...
  const contactHtml = lang === "zh" 
    ? `<p>邮箱: ${t.contact.email}<br>微信/WhatsApp: ${t.contact.whatsapp}<br>地址: ${t.contact.address}</p>`
...
app.listen(PORT, () => {
  console.log(`Privacy Policy server running at http://localhost:${PORT}/privacy-policy`);
  console.log(`English: http://localhost:${PORT}/privacy-policy?lang=en`);
  console.log(`Chinese: http://localhost:${PORT}/privacy-policy?lang=zh`);
});